...
puts "Creating users..."
User.create(username: "Kermit", password_digest: "frog", bio: "I'm green")
User.create(username: "Darth Vader", password_digest: "darksideoftheforce", bio: "I'm ur daddy")
User.create(username: "Cookie Monster", password_digest: "cookie", bio: "COOOOOOOOOKIE")
User.create(username: "Captain Jack Sparrow", password_digest: "rum", bio: "Why is the rum gone?")
#create users
